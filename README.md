...
If Python is your preferred language, checkout [Matt
Stiles’](https://github.com/stiles) Github, he has a
...
[**Analyse the data**](https://survivorstatsdb.com): All the data in one
place to quickly compare and rank players across seasons.
...
If you are interested in counting/timing confessionals, I have a new app
on the Survivor Stats Db.
...
The old app is still included in the package. To launch the app, first
