...
`r max(survivoR::viewers$episode_number_overall)` episodes. `r max(survivoR::viewers$season)` seasons. 1 package!
...
The data is collated and stored in a list. The following code returns all season 1's available in the data set.
...
<a href='https://gradientdescending.com/survivor/US/42/confessionals-rmd.html'><img  height='50' width='auto' src="https://gradientdescending.com/survivor/US/42/confessionals.png" align = 'center'>&nbsp;&nbsp;&nbsp;&nbsp;Confessional counts</a>

Confessional counts from [myself](https://twitter.com/danoehm), [Carly Levitz](https://twitter.com/carlylevitz) and [juststrategic](https://twitter.com/justrategic)
