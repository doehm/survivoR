...
The `challenge_id` is the primary key for the `challenge_description` data set.
...
Please log any suggested corrections on [Github](https://github.com/doehm/survivoR/issues)
