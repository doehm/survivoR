...
* in `challenge_description` the field `turn_based` is now `rounds`. So there are three types of challenges - races, endurance challenges, and challenges played in rounds e.g. By Any Means Necessary. 'Rounds' better reflects the type of challenge it is.
